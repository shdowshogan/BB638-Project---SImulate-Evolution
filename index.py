...
class SimulatorGUI:
    ...
    def setup_ui(self):
        ...
        self.mutation_entry = ttk.Entry(control_frame, width=8, font=('Arial', 11))
        ...
        self.drift_entry = ttk.Entry(control_frame, width=8, font=('Arial', 11))
        ...
        self.migration_entry = ttk.Entry(control_frame, width=8, font=('Arial', 11))
        ...
        self.trait1_entry = ttk.Entry(control_frame, width=8, font=('Arial', 11))
